...
export const defaultTranslations = {
  ...
  tour_rec_title: "Better Soil, Better Yield",
  tour_rec_desc: "Our Crop Advisor recommends crop rotation strategies to maintain soil fertility and prevent disease buildup.",
  tour_schemes_title: "Financial Support",
  tour_schemes_desc: "Find loans and subsidies easily. We explain specific eligibility criteria so you can apply with confidence.",
  tour_market_title: "Smart Market Insights",
  tour_market_desc: "View live Mandi prices nearby and get AI-driven price forecasts to decide when to sell.",
  tour_next: "Next",
  tour_skip: "Skip",
